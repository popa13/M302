...
Answer the following questions.
	\begin{parts}
	\part[10]
	Find the Laplace transform of $f(t) = t \cos (2t) + e^t \sin (t)$.
	
	\vfill
	
	\part[10]
	Find the inverse Laplace transform of $F(s) = \displaystyle \frac{1}{(s + 2) (s - 10)}$.
	\vfill
...
Answer the following questions.
	...
	\part[10]
	Find the inverse Laplace transform of the function $F(s) = \displaystyle \frac{e^{-2s}}{(s - 1)^2}$.
...
\question
	...
	\begin{parts}
	\part[5]
	Denote by $F(s)$ the Laplace transform of $f(t)$. Show that if $h(t) = (t f(t))'$, then $L(h(t)) = -sF'$.
	...
	Find the solution $y(t)$ of the following integral equation:
		\begin{align*}
		\int_0^t y(x) (t - x)^3 \, dx = t^5 .
		\end{align*}
	\vfill
...
Answer the following statements with \textbf{True} or \textbf{False}. Write your answer on the horizontal line at the end of each statement. Justify your answer in the white space underneath each statement.
	...
	\part[2]
	The radius of convergence of a power series solution $\sum_{n = 0}^\infty a_n (x -1)^n$ of the ODE $(1 + x^2) y'' + xy' + y = 0$ is $\sqrt{2}$.
	...
	\part[2]
	If $f(t) = t$ and $g(t) = \sin (t)$, then $L (f(t)g(t)) = \displaystyle \frac{1}{s^2 (s^2 + 1)}$.
	\begin{solution}[\stretch{1}]
	...
	\part[2]
	If $f(t) = u (t - 1)u (t - 2)$, then $f(t) = u (t - 2)$.
	\begin{solution}[\stretch{1}]
	...
	\part[2]
	If $f(t) = t$ and $g(t) = t$, then $f(t) \ast g(t) = \displaystyle \frac{t^3}{6}$.
	\begin{solution}[\stretch{1}]
